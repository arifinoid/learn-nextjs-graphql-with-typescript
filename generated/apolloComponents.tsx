...
> &
  TChildProps;
export type ChangePasswordMutationFn = ReactApollo.MutationFunction<
...
> &
  TChildProps;
export type ForgotPasswordMutationFn = ReactApollo.MutationFunction<
...
export class LogoutComponent extends React.Component<
  Partial<ReactApollo.MutateProps<LogoutMutation, LogoutVariables>>
> {
  render() {
    return (
...
> &
  TChildProps;
export type LogoutMutationFn = ReactApollo.MutationFunction<
  LogoutMutation,
  LogoutVariables
>;
...
export class HelloComponent extends React.Component<
  Partial<ReactApollo.QueryResult<HelloQuery, HelloVariables>>
> {
  render() {
    return (
...
export class MeComponent extends React.Component<
  Partial<ReactApollo.QueryResult<MeQuery, MeVariables>>
> {
  render() {
    return (
